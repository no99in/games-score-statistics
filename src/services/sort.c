...
void sort_project_by_score_no_input(long pid, list *projects, list *contacts, list *schools) {
...
extern void calculate_school_socre(list *projects, list *contacts, list *schools) {
    ...
    long current_id = 1;
    while (current_id < sum_id) {
        sort_project_by_score_no_input(current_id, projects, contacts, schools);
        ++current_id;
    }
