...
void sort_shcool_by_score_no_input(long pid, list *projects, list *contacts, list *schools) {
...
void calculate_school_socre(list *projects, list *contacts, list *schools) {
    ...
    long current_id = 1;
    while (current_id < sum_id) {
        sort_shcool_by_score_no_input(current_id, projects, contacts, schools);
        ++current_id;
    }
...
void calculate_man_projects_socre(list *projects, list *contacts, list *schools) {
    ...
    long current_id = 1;
    while (current_id < sum_id) {
        sort_man_project_by_score_no_input(current_id, projects, contacts, schools);
        ++current_id;
    }
...
void sort_man_project_by_score_no_input(long pid, list *projects, list *contacts, list *schools) {
